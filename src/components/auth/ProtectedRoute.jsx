    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-surface-alt">
        <div className="bg-white border border-red-200 rounded-3xl p-8 text-center max-w-sm mx-4 shadow-sm">
          ...
          <p className="text-ink-muted text-sm">حسابك محظور من قبل إدارة النظام. يرجى التواصل مع الدعم الفني.</p>
        </div>
      </div>
    );
  }
      ...
      return (
        <div className="flex items-center justify-center min-h-screen bg-surface-alt">
          <div className="bg-white border border-amber-200 rounded-3xl p-8 text-center max-w-sm mx-4 shadow-sm">
            ...
            <h2 className="text-xl font-black text-amber-700 mb-2">انتهت صلاحية الاشتراك</h2>
            <p className="text-ink-muted text-sm mb-4">صلاحية اشتراكك منتهية. يرجى التواصل مع الإدارة لتجديد الاشتراك.</p>
            <button onClick={() => {
